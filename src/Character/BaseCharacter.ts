...
export abstract class BaseCharacter {
  ...
  findAbilityScore (ability: string): AbilityScore | undefined {
    return searchInDictionary(ability, this.charAbilityScores) as AbilityScore | undefined;
  }

  findSkill (skillName: string): Skill | undefined {
    return searchInDictionary(skillName, this.charSkills) as Skill | undefined;
  }

  findPassive (passiveName: string): PassiveSkill | undefined {
    return searchInDictionary(passiveName, this.passiveSkills) as PassiveSkill | undefined;
  }
...
export class AbilityScore implements IAbilityScore {
  ...
  private readonly _getModifier: () => number = () =>
...
export class LevelContainer implements ILevelContainer {
  ...
  increaseLevel (className: string): void {
    ...
    if (this.totalLevel < this._maxLevel) {
      if (Number.isFinite(this._levelDictionary[className])) {
  ...
  getClassLevel (className: string): number | undefined {
    return searchInDictionary(className, this._levelDictionary) as number | undefined;
  }
...
export class Proficiency implements IProficiency {
  ...
  private readonly _level: ILevelContainer;
  private _extraBonus: number;

  private readonly _calculateLevelBonus: () => number = () =>
...
export class HealthContainer {
  ...
  private readonly _playerLevels: ILevelContainer;
...
export class Skill implements ISkill {
  ...
  name: string;
  private readonly _ability: IAbilityScore;
  private readonly _proficiency: IProficiency;
...
export class PassiveSkill {
  ...
  private readonly _skill: ISkill;
